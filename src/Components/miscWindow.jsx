  ...
  return (
    ...
    >
      <div className="absolute shrink bg-windowBox dark:bg-darkModeWindow mt-15 w-120 h-90 lg:w-205 lg:h-130 dark:drop-shadow-white drop-shadow-2xl/20 rounded-sm self-center justify-self-center outline-2 dark:outline-white outline-black z-100">
        ...
        <div className="flex flex-col justify-center max-w-full h-78 lg:h-115 max-h-115 text-wrap overflow-y-auto wrap-anywhere dark:text-white dark:text-shadow-white/30 text-shadow-md">
          <div className={`text-center`}>
            <h1 className={`font-outfit text-[2.1rem] lg:text-[3.5rem]`}>
              Fun stuff! :D
            </h1>
            <h1 className="font-outfit text-[.9rem] lg:text-[1.2rem] lg:mb-4">
          ...
          <div
            className={`grid grid-cols-3 lg:ml-10 lg:mr-10 text-center justify-items-center overflow-y-auto font-outfit text-2xl`}
          >
            <div className="border-b-1 border-r-1 lg:mt-5">
              ...
              <h1 className="text-[.9rem] lg:text-[1.1rem] ml-4 mr-4">
              ...
              <div className="mt-3 grid grid-cols-2 justify-items-center mb-5">
                <img
                  src={PhilosofoxPFP}
                  className="rounded-full border-3 lg:size-25 border-black dark:border-white"
                />
                <img
                  src={NikcPic}
                  className="rounded-full border-3 lg:size-25"
                />
              </div>
            </div>
            <div className="border-b-1 border-r-1 lg:mt-5">
              <h1 className="font-outfitMedium text-blue-800 dark:text-blue-500 lg:text-4xl">
                Games I make
              </h1>
              <h1 className="text-[.9rem] lg:text-[1.1rem] mt-1 ml-4 mr-4">
              ...
              <div className="mt-3 grid grid-cols-1 justify-items-center mb-5">
                ...
                >
                  <img
                    src={MountainGoat}
                    className="rounded-full border-3 border-black dark:border-white size-16 lg:size-25 hover:brightness-75 transition-all"
                  />
                </a>
