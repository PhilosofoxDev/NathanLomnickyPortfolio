...
function Window() {
    return (
            <div class="fixed shrink bg-windowBox mb-15 w-205 h-130 rounded-sm self-center justify-self-center outline-2 outline-black z-10"> {/*Change color to whatever works*/}
