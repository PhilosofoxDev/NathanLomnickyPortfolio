...
export default function Window({ homeOpen, homeOnClose }) {
  return (
    ...
    >
      <div className="absolute shrink bg-windowBox dark:bg-darkModeWindow mb-45 w-145 h-105 lg:w-205 lg:h-130 dark:drop-shadow-white drop-shadow-2xl/20 rounded-sm self-center justify-self-center outline-2 dark:outline-white outline-black z-100">
