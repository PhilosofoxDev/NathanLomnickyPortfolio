...
export default function Window({ homeOpen, homeOnClose }) {
  return (
    ...
    >
      <div className="absolute shrink bg-windowBox dark:bg-darkModeWindow mb-45 w-145 h-110 lg:w-205 lg:h-130 dark:drop-shadow-white drop-shadow-2xl/20 rounded-sm self-center justify-self-center outline-2 dark:outline-white outline-black z-100">
        ...
        <div className="flex flex-col justify-center h-90 lg:h-115 max-w-full max-h-115 text-wrap overflow-y-auto wrap-anywhere dark:text-white dark:text-shadow-white/30 text-shadow-md">
          <div className="align-middle font-outfit text-black dark:text-white text-shadow-md dark:text-shadow-white/30">
            <h1 className="text-[3.2rem] lg:text-[4.1rem] mb-1 lg:mb-5 justify-self-center">
              Hey! I'm&nbsp;
              <span className="text-green-700 dark:text-green-500">Nathan</span>
              &nbsp;:&#41;
            </h1>
          </div>
          <h2 className="text-[1.4rem] lg:text-3xl mb-8 lg:mb-20 font-outfit self-center">
            Game Designer, Developer, Creator
          </h2>
          <div className="text-center">
            <h2 className="text-[1.225rem] lg:text-2xl font-outfit mr-5 ml-5">
            ...
            <h2 className="mt-4 font-outfitMedium text-[1rem] lg:text-[1.2rem]">
