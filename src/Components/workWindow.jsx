...
export default function WorkWindow({ workOpen, workOnClose }) {
  ...
  return (
    ...
    >
      <div className="absolute shrink bg-windowBox dark:bg-darkModeWindow not-lg:mb-45 lg:mb-15 w-145 h-105 lg:w-205 lg:h-130 dark:drop-shadow-white drop-shadow-2xl/20 rounded-sm self-center justify-self-center outline-2 dark:outline-white outline-black z-100">
        ...
        <div className="text-black dark:text-white flex flex-col justify-start h-93 lg:h-115 max-w-full max-h-115 text-wrap overflow-y-auto wrap-anywhere">
