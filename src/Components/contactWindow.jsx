      ...
      <div className="absolute shrink bg-windowBox dark:bg-darkModeWindow not-lg:mb-45 lg:mt-15 w-145 h-110 lg:w-205 lg:h-130 dark:drop-shadow-white drop-shadow-2xl/20 rounded-sm self-center justify-self-center outline-2 dark:outline-white outline-black z-100">
        ...
        <div className="flex flex-col justify-center max-h-115 max-w-full text-wrap overflow-y-auto wrap-anywhere">
          <div className={`text-center`}>
            <h1
              className={`font-outfit text-[3rem] lg:text-[3.5rem] dark:text-white dark:text-shadow-white/30 text-shadow-md`}
            >
              Reach out to me!
            </h1>
          </div>
          ...
          <div
            className={`grid grid-cols-1 lg:ml-10 lg:mr-10 text-center justify-items-center overflow-y-auto font-outfit text-[1.3rem] lg:text-2xl dark:text-white dark:text-shadow-white/30 text-shadow-md`}
          >
